...
class Loss(nn.Module):
    ...
    def forward(self, pred_tensor:torch.Tensor, target_tensor:torch.Tensor):
        ...
        coord_mask = target_tensor[:,:,:,4] > 0 # mask for the cells which contain objs [n_batch,S,S]
        noobj_mask = target_tensor[:,:,:,4] == 0 # mask for the cells which do not contain objs [n_batch,S,S]
